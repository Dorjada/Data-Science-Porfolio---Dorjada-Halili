...
number_of_inches = input ("Enter Starting Measurements in Inches: ")

number_of_feet = input ("Enter Starting Measurements in Feet: ")

number_of_yards = input ("Enter Starting Measurements in Yards: ")
